...
public class EditarDatosProfesor extends JFrame {
    ...
    private void placeComponents(JPanel panel) {
        ...
        saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("Guardando datos: " + name + ", " + userName + ", " + email+ " "+ password);
                ...
                try {
                    Profesor profesor = prof.recuperar(usuarioActual.getNombreUsuario());
                    profesor.setNombre(name);
                    profesor.setPassw(password);
                    profesor.setNombreUsuario(userName);
                    profesor.setCorreo(email);
                    prof.modificar(profesor);
